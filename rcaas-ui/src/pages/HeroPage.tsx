...
import DarkModeButton from "../action-bar/DarkModeButton.tsx";
...
export default function HeroPage() {
    ...
    return (
        <div className="flex min-h-screen w-full flex-col items-center justify-center bg-gray-100 p-8 dark:bg-slate-800">

...
import VisualisationButton from "./VisualisationButton.tsx";
import DarkModeButton from "./DarkModeButton.tsx";

export default function ActionBar() {
    return (
        <div
            className="flex flex-none flex-col rounded-t-lg border border-gray-200 bg-white p-2 shadow dark:border-slate-800 dark:bg-slate-700">

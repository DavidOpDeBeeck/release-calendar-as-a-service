...
export default function ActionBar() {
    return (
        <div
            className="flex flex-none flex-col rounded-t-md border-t border-r border-l border-gray-200 bg-white px-4 py-2 shadow dark:border-slate-800 dark:bg-slate-700">
